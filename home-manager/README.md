...
- Shell-Konfigurationen (.bashrc, .gitconfig)
- Anwendungs-Konfigurationen (~/.config/*)
- Benutzerspezifische Pakete (home.packages)
...
## Home Manger NixOS Modul erweitern
...
Bei der Einführung und beim Testen von Home Manager wurden sowohl die `configuration.nix` als auch die `home.nix` zunehmend größer und unübersichtlicher. Daher habe ich mich entschieden, die Konfiguration modularer aufzubauen.
